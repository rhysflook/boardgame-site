...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"savePlayerLocally\": () => (/* binding */ savePlayerLocally),\n/* harmony export */   \"getPlayerId\": () => (/* binding */ getPlayerId),\n/* harmony export */   \"addFriend\": () => (/* binding */ addFriend),\n/* harmony export */   \"getFriendList\": () => (/* binding */ getFriendList)\n/* harmony export */ });\n/* harmony import */ var _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../node_modules/axios/index */ \"./node_modules/axios/index.js\");\n/* harmony import */ var _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0__);\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\r\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\r\n    return new (P || (P = Promise))(function (resolve, reject) {\r\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\r\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\r\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\r\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\r\n    });\r\n};\r\n\r\nconst savePlayerLocally = (id, name) => {\r\n    localStorage.setItem('id', String(id));\r\n    localStorage.setItem('username', String(name));\r\n};\r\nconst getPlayerId = (name = null, isLocal) => {\r\n    const promise = new Promise((resolve) => {\r\n        if (name) {\r\n            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default().get(`../game/getPlayer.php?user=${name}`)\r\n                .then((res) => {\r\n                if (isLocal) {\r\n                    savePlayerLocally(res.data.id, name);\r\n                }\r\n                resolve();\r\n            });\r\n        }\r\n        else {\r\n            resolve();\r\n        }\r\n    });\r\n    return promise;\r\n};\r\nconst addFriend = (name) => __awaiter(void 0, void 0, void 0, function* () {\r\n    const promise = new Promise((resolve) => {\r\n        _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default().get(`../game/getPlayer.php?user=${name}`).then((res) => {\r\n            if (!alreadyFriends(res.data.id)) {\r\n                const reqBody = getFriendReq(res.data.id, name);\r\n                _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default().post('../ui/addFriend.php', reqBody)\r\n                    .then((res) => {\r\n                    if (res) {\r\n                        const friends = JSON.parse(localStorage.getItem('friends'));\r\n                        friends.push({ id: reqBody.friendId, name });\r\n                        localStorage.setItem('friends', JSON.stringify(friends));\r\n                        resolve({\r\n                            id: reqBody.friendId,\r\n                            name,\r\n                            online: false,\r\n                            inGame: false,\r\n                        });\r\n                    }\r\n                });\r\n            }\r\n        });\r\n    });\r\n    return promise;\r\n});\r\nconst alreadyFriends = (id) => {\r\n    const friends = JSON.parse(localStorage.getItem('friends')).map((friend) => friend.id);\r\n    return friends === null || friends === void 0 ? void 0 : friends.includes(id);\r\n};\r\nconst getFriendReq = (id, name) => {\r\n    return {\r\n        id: Number(localStorage.getItem('id')),\r\n        name: localStorage.getItem('username'),\r\n        friendId: id,\r\n        friendName: name,\r\n    };\r\n};\r\nconst getFriendList = () => {\r\n    return _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default().get(`../ui/getFriends.php?id=${Number(localStorage.getItem('id'))}`)\r\n        .then((res) => {\r\n        const friends = [];\r\n        const userId = Number(localStorage.getItem('id'));\r\n        res.data.forEach((friendship) => {\r\n            friends.push(friendship[0] === userId\r\n                ? {\r\n                    id: friendship[1],\r\n                    name: friendship[3],\r\n                    online: false,\r\n                    inGame: false,\r\n                }\r\n                : {\r\n                    id: friendship[0],\r\n                    name: friendship[2],\r\n                    online: false,\r\n                    inGame: false,\r\n                });\r\n        });\r\n        localStorage.setItem('friends', JSON.stringify(friends));\r\n    });\r\n};\r\n\n\n//# sourceURL=webpack:///./src/api.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"InviteWindow\": () => (/* binding */ InviteWindow)\n/* harmony export */ });\n/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api */ \"./src/api.ts\");\n/* harmony import */ var _game_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../game/utils */ \"./src/game/utils.ts\");\n/* harmony import */ var _socket_MenuSocket__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../socket/MenuSocket */ \"./src/socket/MenuSocket.ts\");\n/* harmony import */ var _templates_invite__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../templates/invite */ \"./src/templates/invite.ts\");\n/* harmony import */ var _ui_ChatArea__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../ui/ChatArea */ \"./src/ui/ChatArea.ts\");\n/* harmony import */ var _ui_FriendList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ui/FriendList */ \"./src/ui/FriendList.ts\");\n\r\n\r\n\r\n\r\n\r\n\r\nconst axios = (__webpack_require__(/*! axios */ \"./node_modules/axios/index.js\")[\"default\"]);\r\nconst menu = document.querySelector('.menu-container');\r\nclass InviteWindow extends HTMLDivElement {\r\n    constructor(player, userId, socket) {\r\n        super();\r\n        this.player = player;\r\n        this.userId = userId;\r\n        this.socket = socket;\r\n        this.acceptInvite = () => {\r\n            localStorage.setItem('opponentId', String(this.userId));\r\n            localStorage.setItem('opponentName', this.player);\r\n            window.location.href = `../../src/game/draughts.php?opponent=${this.userId}`;\r\n        };\r\n        this.rejectInvite = () => {\r\n            this.socket.send(JSON.stringify({ type: 'end' }));\r\n            this.remove();\r\n        };\r\n        this.classList.add('popup');\r\n        let shadowRoot = this.attachShadow({ mode: 'open' });\r\n        shadowRoot.appendChild((0,_templates_invite__WEBPACK_IMPORTED_MODULE_3__.getTemplate)('invitation'));\r\n        const message = shadowRoot.getElementById('message');\r\n        if (message) {\r\n            message.innerText = `${(0,_game_utils__WEBPACK_IMPORTED_MODULE_1__.capitalise)(this.player)} wants to play!`;\r\n        }\r\n        const accept = shadowRoot.getElementById('accept');\r\n        if (accept) {\r\n            accept.addEventListener('click', this.acceptInvite);\r\n        }\r\n        const reject = shadowRoot.getElementById('reject');\r\n        if (reject) {\r\n            reject.addEventListener('click', this.rejectInvite);\r\n        }\r\n    }\r\n    connectedCallback() {\r\n        setTimeout(() => this.rejectInvite(), 30000);\r\n    }\r\n}\r\ncustomElements.define('x-invite-window', InviteWindow, { extends: 'div' });\r\nconst queryString = window.location.search;\r\nconst urlParams = new URLSearchParams(queryString);\r\nconst player = urlParams.get('user');\r\nconst username = player === null ? localStorage.getItem('username') : player;\r\n(0,_api__WEBPACK_IMPORTED_MODULE_0__.getPlayerId)(username, true).then(() => {\r\n    axios.get('../socket-url.php').then((res) => {\r\n        const socket = new _socket_MenuSocket__WEBPACK_IMPORTED_MODULE_2__.MenuSocket(res.data);\r\n        menu.append(new _ui_FriendList__WEBPACK_IMPORTED_MODULE_5__.FriendList(socket));\r\n        menu.append(new _ui_ChatArea__WEBPACK_IMPORTED_MODULE_4__.ChatArea(socket));\r\n    });\r\n});\r\n\n\n//# sourceURL=webpack:///./src/menu/gameMenu.ts?");

/***/ }),

/***/ "./src/socket/MenuSocket.ts":
/*!**********************************!*\
  !*** ./src/socket/MenuSocket.ts ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"MenuSocket\": () => (/* binding */ MenuSocket)\n/* harmony export */ });\n/* harmony import */ var _game_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../game/utils */ \"./src/game/utils.ts\");\n/* harmony import */ var _MessageHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MessageHandler */ \"./src/socket/MessageHandler.ts\");\n\r\n\r\nclass MenuSocket extends WebSocket {\r\n    constructor(url) {\r\n        super(url);\r\n        this.getFriendStatus = (id, name) => {\r\n            this.send(JSON.stringify({ type: 'status', id, name }));\r\n        };\r\n        this.setupConnection = () => {\r\n            const userId = (0,_game_utils__WEBPACK_IMPORTED_MODULE_0__.getCookie)('id');\r\n            if (userId) {\r\n                this.send(JSON.stringify({\r\n                    type: 'start',\r\n                    id: Number(userId),\r\n                }));\r\n            }\r\n        };\r\n        this.setupMessageHandlers = () => {\r\n            const handler = new _MessageHandler__WEBPACK_IMPORTED_MODULE_1__.MessageHandler();\r\n            this.addEventListener('message', (event) => {\r\n                const data = JSON.parse(event.data);\r\n                if (Object.getOwnPropertyNames(handler).includes(data.type)) {\r\n                    handler[data.type](data, this);\r\n                }\r\n            });\r\n        };\r\n        this.addEventListener('open', () => {\r\n            this.setupConnection();\r\n            this.setupMessageHandlers();\r\n        });\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/socket/MenuSocket.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"MessageHandler\": () => (/* binding */ MessageHandler)\n/* harmony export */ });\n/* harmony import */ var _menu_gameMenu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../menu/gameMenu */ \"./src/menu/gameMenu.ts\");\n\r\nclass MessageHandler {\r\n    constructor() {\r\n        this.invite = (data, socket) => {\r\n            const menu = document.querySelector('.menu-container');\r\n            menu.appendChild(new _menu_gameMenu__WEBPACK_IMPORTED_MODULE_0__.InviteWindow(data.username, data.id, socket));\r\n        };\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/socket/MessageHandler.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"ChatArea\": () => (/* binding */ ChatArea)\n/* harmony export */ });\n/* harmony import */ var _ChatGroup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ChatGroup */ \"./src/ui/ChatGroup.ts\");\n\r\nclass ChatArea extends HTMLElement {\r\n    constructor(socket) {\r\n        super();\r\n        this.socket = socket;\r\n        this.render = () => {\r\n            var _a, _b;\r\n            const html = `\r\n    <link rel=\"stylesheet\" href=\"../../menu.css\">\r\n    <div id=\"chatArea\">\r\n    </div>\r\n    `;\r\n            const tmpl = document.createElement('template');\r\n            tmpl.innerHTML = html;\r\n            (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.appendChild(tmpl.content.cloneNode(true));\r\n            const chat = (_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.getElementById('chatArea');\r\n            const user = localStorage.getItem('username');\r\n            const globalChat = new _ChatGroup__WEBPACK_IMPORTED_MODULE_0__.ChatGroup(this.socket, user, 'global');\r\n            chat === null || chat === void 0 ? void 0 : chat.appendChild(globalChat);\r\n        };\r\n        const shadowRoot = this.attachShadow({ mode: 'open' });\r\n        this.render();\r\n    }\r\n}\r\ncustomElements.define('x-chat-area', ChatArea);\r\n\n\n//# sourceURL=webpack:///./src/ui/ChatArea.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"ChatGroup\": () => (/* binding */ ChatGroup)\n/* harmony export */ });\n/* harmony import */ var _chatbox_Message__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../chatbox/Message */ \"./src/chatbox/Message.ts\");\n\r\nclass ChatGroup extends HTMLElement {\r\n    constructor(socket, localUser, groupName, isGlobal = true) {\r\n        super();\r\n        this.socket = socket;\r\n        this.localUser = localUser;\r\n        this.groupName = groupName;\r\n        this.isGlobal = isGlobal;\r\n        this.collapsed = true;\r\n        this.chat = [];\r\n        this.handleIncomingMessage = () => {\r\n            this.socket.addEventListener('message', (event) => {\r\n                var _a;\r\n                const data = JSON.parse(event.data);\r\n                if (data.type === 'chatMessage') {\r\n                    const message = new _chatbox_Message__WEBPACK_IMPORTED_MODULE_0__.Message(data.content, data.sender, data.sender === this.localUser);\r\n                    this.chat.push(message);\r\n                    const chatBox = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById(this.groupName + '-chat');\r\n                    chatBox === null || chatBox === void 0 ? void 0 : chatBox.appendChild(message.renderMessage());\r\n                }\r\n            });\r\n        };\r\n        this.sendMessage = () => {\r\n            var _a;\r\n            const chatInput = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById('chatContent');\r\n            this.socket.send(JSON.stringify({\r\n                type: 'chatMessage',\r\n                content: chatInput.value,\r\n                sender: this.localUser,\r\n                id: this.localId,\r\n            }));\r\n            // const chatBox = this.shadowRoot?.getElementById(this.groupName + '-chat');\r\n            // const message = new Message(chatInput.value, this.localUser, true);\r\n            // this.chat.push(message);\r\n            // chatBox?.appendChild(message.renderMessage());\r\n        };\r\n        this.toggleChar = () => {\r\n            var _a;\r\n            const button = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById('open');\r\n            if (button) {\r\n                button.addEventListener('click', () => {\r\n                    var _a;\r\n                    this.collapsed = !this.collapsed;\r\n                    this.renderAllMessage();\r\n                    if (!this.collapsed) {\r\n                        const send = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById('sendChat');\r\n                        send.addEventListener('click', () => {\r\n                            this.sendMessage();\r\n                        });\r\n                    }\r\n                });\r\n            }\r\n        };\r\n        this.renderAllMessage = () => {\r\n            var _a;\r\n            const chatBox = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById(this.groupName + '-chat');\r\n            if (this.collapsed && chatBox) {\r\n                chatBox.innerHTML = '';\r\n            }\r\n            else if (chatBox) {\r\n                chatBox.innerHTML = `\r\n      <div id=\"sendBar\">\r\n        <input type=\"text\" id=\"chatContent\"/>\r\n        <button id=\"sendChat\" class=\"popup-button short\">Send</button>\r\n      </div>\r\n      `;\r\n                this.chat.forEach((message) => {\r\n                    console.log('yo');\r\n                    chatBox === null || chatBox === void 0 ? void 0 : chatBox.appendChild(message);\r\n                });\r\n            }\r\n        };\r\n        this.render = () => {\r\n            var _a;\r\n            const html = `\r\n    <link rel=\"stylesheet\" href=\"../../menu.css\">\r\n      <div id=\"${this.groupName}\">\r\n        <button id=\"open\" class=\"popup-button short corner\">${this.groupName}</button>\r\n        <div id=\"${this.groupName}-chat\">\r\n        </div>\r\n      </div>\r\n      `;\r\n            const tmpl = document.createElement('template');\r\n            tmpl.innerHTML = html;\r\n            (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.appendChild(tmpl.content.cloneNode(true));\r\n            console.log('yo');\r\n        };\r\n        const shadowRoot = this.attachShadow({ mode: 'open' });\r\n        this.localId = Number(localStorage.getItem('id'));\r\n        this.render();\r\n        this.handleIncomingMessage();\r\n        this.toggleChar();\r\n    }\r\n}\r\ncustomElements.define('x-chat-group', ChatGroup);\r\n\n\n//# sourceURL=webpack:///./src/ui/ChatGroup.ts?");

/***/ }),

/***/ "./src/ui/FriendList.ts":
/*!******************************!*\
  !*** ./src/ui/FriendList.ts ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
